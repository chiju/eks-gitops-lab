...
# SSO roles follow predictable pattern: arn:aws:iam::{account}:role/aws-reserved/sso.amazonaws.com/{region}/AWSReservedSSO_{PermissionSetName}_{random}
# We use wildcard for the random suffix since it's generated by AWS
locals {
  sso_role_arns = {
    "PlatformAdmin"  = "arn:aws:iam::${local.account_id}:role/aws-reserved/sso.amazonaws.com/*/AWSReservedSSO_PlatformAdmin_*"
    "DevOpsEngineer" = "arn:aws:iam::${local.account_id}:role/aws-reserved/sso.amazonaws.com/*/AWSReservedSSO_DevOpsEngineer_*"
    "Developer"      = "arn:aws:iam::${local.account_id}:role/aws-reserved/sso.amazonaws.com/*/AWSReservedSSO_Developer_*"
    "ReadOnly"       = "arn:aws:iam::${local.account_id}:role/aws-reserved/sso.amazonaws.com/*/AWSReservedSSO_ReadOnly_*"
  }
